...
function UpComingWebinars() {
    const finalWebinars = featuredWebinars.filter(
        (webinars) => webinars.isFeatured
    );
    return (
        <div className="py-12 bg-gray-900">
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
                <div className="text-center">
                    <h2 className="flex justify-center text-center test-base text-teal-600 font-semibold tracking-wide uppercase">
                        Featured Webniars
                    </h2>
